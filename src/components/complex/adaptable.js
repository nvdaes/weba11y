...
const Adaptable = () => {
	return (
		...
		<li>El propósito de campos para la entrada de datos, y el de las regiones de la página web, debe identificarse de modo que pueda ser interpretado por distintas herramientas tecnológicas. En cuanto a la entrada de datos, podemos comprobar el funcionamiento del atributo <code>autocomplete</code> en el formulario de contacto de la web de la comunidad hispanohablante de <abbr title="Non Visual Desktop Access">NVDA</abbr>. Aquí mencionaremos el criterio relativo al propósito de las regiones.</li>
		</ul>

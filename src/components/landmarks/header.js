...
const Header = () => {
	return (
		...
		<p>Además de estas pautas, se han consultado otras publicaciones del <abbr title="World Wide Web Consortium">W3C</abbr>, como queda reflejado en los enlaces de esta web.</p>

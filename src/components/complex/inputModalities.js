...
const InputModalities = () => {
	return (
		...
		<p>Aunque debemos considerar todos los criterios de esta pauta, aquí nos detendremos en el relativo a <q>etiquetas en nombre</q>, ya que <abbr title="Non Visual Desktop Access">NVDA</abbr> puede resultar especialmente útil para comprenderlo y determinar si el contenido de una web o documento se ajusta a este requisito.</p>
		</>
	)
}
